...
@HippoEssentialsGenerated(internalName = "myassignment:contentdocument")
@Node(jcrType = "myassignment:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "myassignment:introduction")
    public String getIntroduction() {
        return getProperty("myassignment:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "myassignment:mypublicationdate")
    public Calendar getPublicationDate() {
        return getProperty("myassignment:mypublicationdate");
    }
}
